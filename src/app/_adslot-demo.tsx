  ...
  return (
    <div className="container">
      <header className="header">
        ...
        <p>
          Interactive demonstration of the NLCyber AdSlot React component with
          various configurations and placements
        </p>
      </header>
      ...
      <main className="main">
        <div className="content">
          <section id="homepage" className="demo-section">
            ...
            <p>
              This demonstrates a standard banner ad placement at the top of a
              homepage. The ad will automatically select from available
              campaigns and handle frequency capping.
            </p>
              ...
              <div className="ad-content">
                {AdSlot ? (
                  ...
                  <div style={{ color: "#6c757d", textAlign: "center" }}>
                    AdSlot component not loaded. Please check the package
                    installation.
                  </div>
                )}
              </div>
...
/>`}</pre>
          ...
          <section id="article" className="demo-section">
            ...
            <p>
              Ads can be seamlessly integrated within article content. This
              example shows how ads appear in the natural flow of content.
            </p>
...
/>`}</pre>
          ...
          <section id="config" className="demo-section">
            ...
            <p>
              Customize the AdSlot behavior with various configuration options:
            </p>
...
- Label Text: "Advertisement"`}</pre>
          ...
          <section className="demo-section">
            ...
            <div className="features">
              <div className="feature">
                ...
                <p>
                  Weighted rotation with priority tiers for optimal ad
                  performance
                </p>
              </div>
              <div className="feature">
      ...
      <footer className="footer">
        <div className="container">
          <p>
            &copy; 2024 NLCyber AdSlot Demo. Built with React and the NLCyber
            AdSlot component.
          </p>
        </div>
      </footer>
...
function AdSlotDemoWithErrorBoundary() {
  const [loadError, setLoadError] = useState<string | null>(null);
  useEffect(() => {
    try {
      if (!AdSlot) {
        setLoadError(
          "Failed to load AdSlot component. Ensure nlcyber-adslot is installed."
        );
      }
    } catch (e:any) {
...
export { AdSlotDemoWithErrorBoundary as AdSlotDemo };
